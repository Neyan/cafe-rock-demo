...
class LunchScreen extends React.Component {
  ...
  async saveOrder() {
    ...
    let newNote = {
      body: {
        "orderdate": "2019-03-14",
        "customerid": "Sankar111",
        "orderid": '7',
		"itemid": '777',
		"price": "1",
		"quantity": "1",
    ...
    try {
      ...
      console.log("response from saving note: " + JSON.stringify(this.state.apiResponse));
      ...
      return (
        <Modal
          ...
          <View style={styles.modelStyle}>
			...
			/>
			<Button title="Check Out" onPress={this.saveOrder.bind(this)} />
